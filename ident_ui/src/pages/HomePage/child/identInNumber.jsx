      ...
      <div className="card-container">
        <div className="container">
          <div className="img-container">
            <img src="https://i.ibb.co/xq6QsrS/like-icon.png" alt="" />
          </div>
        ...
        <div className="container">
          <div className="img-container">
            <img src="https://i.ibb.co/h267L0V/badge-icon.png" alt="" />
          </div>
        ...
        <div className="container">
          <div className="img-container">
            <img src="https://i.ibb.co/r7dwjN9/member-icon.png" alt="" />
          </div>
        ...
        <div className="container">
          <div className="img-container">
            <img src="https://i.ibb.co/vq5sfn9/smile-icon.png" alt="" />
          </div>
